...
// Note: Slightly modified to work better in Fox.
...
// - Added a new parameter `ignore_y_` in the `Agent`. This parameter is used to control a Fox feature that allows to avoid collisions by moving on the horizontal plane.
namespace RVO {
/**
...
public:
    ...
    /// This is a Fox feature that allows the Agent to avoid collision by mooving
