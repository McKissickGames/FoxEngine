...
namespace FoxTools.BuildLogger
{
    public class FoxBuildLogger : ILogger
    {
        public static readonly string AssemblyPath = Path.GetFullPath(typeof(FoxBuildLogger).Assembly.Location);
