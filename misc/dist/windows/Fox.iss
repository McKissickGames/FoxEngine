...
AppComments=Fox Engine editor
ChangesEnvironment=yes
DefaultDirName={localappdata}\Fox
DefaultGroupName=Fox Engine
AllowNoIcons=yes
UninstallDisplayIcon={app}\{#MyAppExeName}
#ifdef App32Bit
  OutputBaseFilename=Fox-setup-x86
#else
  OutputBaseFilename=Fox-setup-x86_64
...
Name: "modifypath"; Description: "Add Fox to PATH environment variable"
