// This service worker is required to expose an exported Fox project as a
// Progressive Web App. It provides an offline fallback page telling the user
// that they need an Internet connection to run the project if desired.
// Incrementing CACHE_VERSION will kick off the install event and force
// previously cached resources to be updated from the network.
const CACHE_VERSION = "@Fox_VERSION@";
const CACHE_NAME = "@Fox_NAME@-cache";
const OFFLINE_URL = "@Fox_OFFLINE_PAGE@";
// Files that will be cached on load.
const CACHED_FILES = @Fox_CACHE@;
// Files that we might not want the user to preload, and will only be cached on first load.
const CACHABLE_FILES = @Fox_OPT_CACHE@;
